...
# -*- coding: utf-8 -*-
"""
export_counterparties_region6.py
================================

Entity resolution for Region6_1404.xlsx
"""
...
SOURCE_EXCEL_PATH = Path(r"f:\Freelancing_Project\KalaniProject\municipality_demo\data\reports\Region6_1404.xlsx")
OUTPUT_EXCEL_PATH = Path(r"f:\Freelancing_Project\KalaniProject\municipality_demo\data\reports\Clean_Counterparties_Region6.xlsx")
...
def main():
    ...
    print("=" * 70)
    print("Entity Resolution for Region 6 Dataset")
    print("=" * 70)
